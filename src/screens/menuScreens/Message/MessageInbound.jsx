  ...
  return (
    <div className="flex flex-col w-full h-screen">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <div className="w-full md:w-1/3 lg:w-1/4 border-r border-gray overflow-y-auto">
          <MessageInboundConv />
        </div>

        {/* Center Section (Chat UI) */}
        <div className="hidden md:block w-full md:w-2/3 lg:w-1/2 flex-1 overflow-y-auto">
          <ChatUI/>
        </div>
