...
const messages = [
  { id: 1, name: "Dave O.", message: "Where is my order?", time: "1h", iconType: "shopping", app: "instagram", messages: [
    { sender: "user", text: "Where is my order?" },
    { sender: "agent", text: "Let me check that for you. Can you provide your order number?" }
  ] },
  { id: 2, name: "Jessica R.", message: "Do you have gift cards?", time: "1h", iconType: "gift", app: "whatsapp", messages: [
  ...
  { id: 3, name: "Robert S.", message: "What's my tracking number?", time: "1h", iconType: "shopping", app: "facebook", messages: [
    { sender: "user", text: "What's my tracking number?" },
    { sender: "agent", text: "I'll help you find your tracking number. What's your order ID?" }
  ] },
  { id: 5, name: "IP 543.658...", message: "Do you ship internationally?", time: "1h", iconType: "message", app: "instagram", messages: [
    { sender: "user", text: "Do you ship internationally?" },
    { sender: "agent", text: "Yes, we do ship internationally to many countries!" }
  ] },
  { id: 6, name: "tashamach247@...", message: "Cancel my order, please", time: "1h", iconType: "link", app: "whatsapp", messages: [
  ...
  { id: 7, name: "Stephen P.", message: "Voice call", time: "1h", iconType: "phone", messages: [
    { sender: "user", text: "Voice call" },
    { sender: "agent", text: "I see you requested a voice call. Our agent will call you shortly." }
  ] },
  { id: 8, name: "Monica T.", message: "Is this jacket available?", time: "1h", iconType: "message", messages: [
